...
/**
 * A dialog that prompts the user for the time of day using a {@link DurationPicker}.
 */
public class DurationPickerDialog extends AlertDialog implements OnClickListener,
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(DurationPicker view, int hourOfDay, int minute, int seconds);
    }
    ...
    private final DurationPicker mTimePicker;
    ...
    public DurationPickerDialog(Context context,
        ...
        setView(view);
        mTimePicker = (DurationPicker) view.findViewById(R.id.timePicker);
