 ...
 */
internal class DownloadTask(private val mContext: Context, private val mDbxClient: DbxClientV2, private val mCallback: Callback) : AsyncTask<FileMetadata, Void, File>() {
