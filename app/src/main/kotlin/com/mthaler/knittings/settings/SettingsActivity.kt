...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    override fun isValidFragment(fragmentName: String): Boolean {
        return PreferenceFragment::class.java.name == fragmentName
                || SharePreferenceFragment::class.java.name == fragmentName
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    class SharePreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            addPreferencesFromResource(R.xml.pref_sharing)
            setHasOptionsMenu(true)
            // Bind the summaries of EditText/List/Dialog/Ringtone pref_sharing
