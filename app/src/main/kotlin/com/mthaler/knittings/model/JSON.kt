...
fun JSONObject.toDatabase(context: Context, externalFilesDir: File): Database {
    ...
    val rowCounters = if(has("rowCounters")) getJSONArray("rowCounters").toRowCounters() else ArrayList()
    ...
    return Database(knittings, photosWithUpdatedFilename, categories, needles, rowCounters)
}
