...
object DeleteNeedleDialog {
    ...
    fun create(context: Context, needleName: Needle, onDelete: () -> Unit): AlertDialog {
        // create the dialog
        val b = AlertDialog.Builder(context)
        b.setTitle(R.string.delete_needle_dialog_title)
        b.setMessage(context.resources.getString(R.string.delete_needle_dialog_question, needleName))
